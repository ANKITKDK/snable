    ...
    return (() => {
        var r = {
                3302: function (r, t, e) {
                    ...
                    !(function (o) {
                        ...
                        function d(r, t, e, n) {
                            ...
                            if (t < 1)
                                (n = (3 === e && (n || !!o[0])) || (0 === t && ((1 === e && o[0] >= 5) || (2 === e && (o[0] > 5 || (5 === o[0] && (n || o[1] !== p))))))),
                                    (o.length = 1),
                                    n ? ((r.e = r.e - t + 1), (o[0] = 1)) : (o[0] = r.e = 0);
                            else if (t < o.length) {
                        ...
                        (l.abs = function () {
                            ...
                            (l.cmp = function (r) {
                                ...
                                for (u = (f = n.length) < (c = o.length) ? f : c, i = -1; ++i < u; ) if (n[i] != o[i]) return (n[i] > o[i]) ^ t ? 1 : -1;
                            ...
                            (l.minus = l.sub = function (r) {
                                ...
                                if ((o && ((n = s), (s = l), (l = n), (r.s = -r.s)), (c = (e = l.length) - (t = s.length)) > 0)) for (; c--; ) s[t++] = 0;
                                for (c = t; e > f; ) {
                                    if (s[--e] < l[e]) {
                                        for (t = e; t && !s[--t]; ) s[t] = 9;
                                        --s[t], (s[e] += 10);
                            ...
                            (l.sqrt = function () {
                                ...
                                0 === (i = Math.sqrt(n + "")) || i === 1 / 0
                                    ? (((t = n.c.join("")).length + u) & 1 || (t += "0"),
                                      (u = (((u + 1) / 2) | 0) - (u < 0 || 1 & u)),
                                      (r = new o(((i = Math.sqrt(t)) == 1 / 0 ? "5e" : (i = i.toExponential()).slice(0, i.indexOf("e") + 1)) + u)))
                                    : (r = new o(i + "")),
                                    (u = r.e + (o.DP += 4));
                                do {
                                ...
                                function t(e) {
                                    ...
                                    if (e instanceof t) (n.s = e.s), (n.e = e.e), (n.c = e.c.slice());
                                        ...
                                        !(function (r, t) {
                                            ...
                                            for (
                                                r.s = "-" == t.charAt(0) ? ((t = t.slice(1)), -1) : 1,
                                                    (e = t.indexOf(".")) > -1 && (t = t.replace(".", "")),
                ...
                1640: (r, t, e) => {
                    ...
                    r.exports = function (r, t, e) {
                        return (
                            e && "number" != typeof e && u(r, t, e) && (t = e = void 0),
                            (e = void 0 === e ? 4294967295 : e >>> 0) ? ((r = s(r)) && ("string" == typeof t || (null != t && !f(t))) && !(t = n(t)) && i(r) ? o(c(r), 0, e) : r.split(t, e)) : []
                        );
                    };
                },
                240: (r, t, e) => {
                        ...
                        (t = t.nodeType ? t : document.querySelector(t)).addEventListener("input", function () {
                            e.split("|").forEach(function (e) {
                                ...
                                !(function (r, t, e, n) {
                                    ...
                                    e
                                        ? i && (r.classList.pxove(P), (i.style.display = "none"))
                                        : (i
                                              ? ((i.innerHTML = n), (i.style.display = "inline-block"))
                                              : ((i = document.createElement("div")), r.parentNode.appendChild(i), (i.style.display = "inline-block"), i.classList.add("invalid-feedback", o), (i.innerHTML = n)),
                                          r.classList.contains(P) || r.classList.add(P));
                                })(t, u, s, f),
                                    o()(n) && n(s);
                            });
                        });
