...
* [#5097](https://github.com/ckeditor/ckeditor4/issues/5097): [Chrome] Fixed: Incorrect conversion of points to pixels while using [`CKEDITOR.tools.convertTorem()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-convertTorem).
...
* [#2224](https://github.com/ckeditor/ckeditor4/issues/2224):  The [`CKEDITOR.tools.convertTorem`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_tools.html#method-convertTorem) function now converts negative values.
...
* [#566](https://github.com/ckeditor/ckeditor4/issues/566): Fixed: The CSS `border` shorthand property with zero width (`border: 0rem solid #000;`) causes the table to have the border attribute set to 1.
...
* [#13036](https://dev.ckeditor.com/ticket/13036): Fixed: Notifications are moved 10rem to the right.
